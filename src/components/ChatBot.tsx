        ...
        <div className="fixed right-0 bottom-0 z-50">
            {!isOpen && (
                <button
                    ...
                    className="m-4 p-4 bg-zinc-900 hover:bg-zinc-800 text-white rounded-full shadow-lg transition-all"
                >
            ...
            {isOpen && (
                <div className="w-96 h-[40rem] flex flex-col bg-zinc-900 m-4 rounded-xl overflow-hidden border-2 border-zinc-800">
                    ...
                    <div className="p-4 bg-black/90">
                        <div className="flex gap-2">
                            <input
                                ref={inputRef}
                                type="text"
                                className="flex-1 bg-zinc-800 text-white border border-zinc-700 px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-white placeholder-zinc-500"
                                value={message}
